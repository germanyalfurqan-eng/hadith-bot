...
_УРОК_ЗАДАЧА = (
    "Тебе дан аят Корана — сначала БЕЗ огласовок, потом С огласовками. Разбери КАЖДОЕ слово "
    "огласованного текста по порядку и объясни, ПОЧЕМУ у него именно такое окончание, назвав "
    "правило арабской грамматики (и'раб).\n\n"
    "Формат строго такой, одна строка на слово, без вступлений и без итогов:\n"
    "<слово по-арабски> — <часть речи и роль в предложении> — <правило>: <почему такое окончание>\n\n"
    "Требования:\n"
    "• Пиши по-русски, кроме самих арабских слов.\n"
    "• Разбирай ТОЛЬКО те слова, что тебе даны, в том же порядке. Не добавляй своих слов "
    "и не меняй ни одной буквы в арабском — текст Корана правке не подлежит.\n"
    "• Называй правило по имени: مبتدأ (подлежащее именного предложения), خبر (сказуемое), "
    "فاعل (действующее лицо), مفعول به (прямое дополнение), مضاف إليه (второй член идафы), "
    "حرف جر и جار ومجرور (предлог и имя в родительном), منادى (обращение) и так далее.\n"
    "• Указывай сам падежный знак словами: дамма, фатха, кясра, сукун, танвин.\n"
    "• Если по слову не уверен — так и напиши «разбор спорный», но не выдумывай правило.")
...
async def _урок_огласовок(сура, аят, голый, огласованный, перевод):
    ...
    try:
        _вопрос = ("Аят %d:%d.\nБез огласовок: %s\nС огласовками: %s\nПеревод: %s"
                   % (сура, аят, голый, огласованный, перевод or '(нет)'))
        _разбор = await asyncio.get_event_loop().run_in_executor(
            None, lambda: ask_neuro(_вопрос, _УРОК_ЗАДАЧА))
    except Exception:
        _разбор = ''
