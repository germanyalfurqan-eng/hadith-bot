    ...
    async def neuro(r):
        ...
        try:
            ...
            sysm = ("Ты помогаешь искать аяты Корана и хадисы ПО-АРАБСКИ. Запрос на русском/английском — это "
                    "ЛИБО ТРАНСКРИПЦИЯ арабского слова/фразы (русскими/лат. буквами), ЛИБО тема/смысл.\n"
                    "• Если это транскрипция арабского выражения — верни ИМЕННО это арабское выражение и 1-2 его формы. "
                    "Примеры: «ляхуа хадис»→لهو الحديث ; «бида»→بدعة، البدعة ; «иджтихад»→اجتهاد، الاجتهاد ; «таухид»→التوحيد.\n"
                    "• Если это тема/смысл — верни 4-8 ключевых арабских слов/фраз по теме (с артиклем и без).\n"
