...
СБОРКА = 'b1250-rag-porog-zhurnal-bany'
...
async def handle(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if is_owner(update):
        ...
        # владелец чата. Во-вторых, к сегодняшнему дню в bot.py не осталось НИ ОДНОГО вызова
        # ban_chat_member — то есть бот теперь даже не пытается, и «бан <id>» стал молча значить
