...
«المهيمن» («аль-Мухаймин») имама Муршида ибн Юсуфа — подзаголовок «الإسلام كما جاء في القرآن الكريم والسنة النبوية», то есть «Ислам, как он пришёл в Коране и Сунне Пророка». Так книга названа на обложке и на 49-й странице словами самого автора (≈3300 авторских номеров, ≈7600 риваятов),
...
ГОЛОС. Если человек прислал голосовое или просит ответить голосом — бот озвучит ответ и
пришлёт голосовым сообщением; русский текст читает русский голос, арабский — арабский.
Голосовое без обращения к тебе бот разбирает сам и ищет в нём оригинал хадиса.
...
ГОЛОСА = {"ru": "ru-RU-DmitryNeural", "ar": "ar-SA-HamedNeural", "en": "en-US-GuyNeural"}
