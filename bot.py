...
_RAG_LEX = {
    ('музык', 'песн', 'пени', 'инструмент'): ['المعازف', 'الغناء', 'مزمار', 'الملاهي'],
    ...
    ('еда', 'пищ', 'кушан', 'трапез', 'есть'): ['الطعام', 'الأكل'],
            ...
            if True:
                ...
                if _q or _src:
                    ...
                    if _q and not re.search(r'[؀-ۿ]', _q):
                        _terms = _ru_ar_terms(_q)
                    if not _terms and _q and not re.search(r'[؀-ۿ]', _q):
                        try:
                            _kw = ask_ai(
