...
async def handle(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    def _из_канала(u):
        ...
        try:
            ...
            if not _sc:
                return False
            # sender_chat, равный самому чату, — это анонимный админ, обычный человек. А вот
            # ЧУЖОЙ sender_chat (канал) — публикация.
            return getattr(_sc, 'id', None) != getattr(u.effective_chat, 'id', None)
        except Exception:
            return False
