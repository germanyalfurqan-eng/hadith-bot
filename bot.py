...
async def _api_serve(application=None):
    ...
    async def neuro(r):
        ...
        try:
            ...
            sysm = ("Ты помогаешь искать аяты Корана и хадисы ПО-АРАБСКИ. Запрос на русском/английском — это "
                    "ЛИБО ТРАНСКРИПЦИЯ конкретного арабского слова/фразы (записанного русскими/лат. буквами), "
                    "ЛИБО тема/смысл. СНАЧАЛА реши, что это.\n"
                    "• ТРАНСКРИПЦИЯ (звучит как арабское слово): верни ТОЛЬКО это арабское слово/фразу и её формы "
                    "(с артиклем الـ и без). НЕ добавляй тематические синонимы и НЕ уходи в смысл. "
                    "Примеры: «иджтихад»→اجتهاد / الاجتهاد (НЕ النار, НЕ العلم) ; «бида»→بدعة / البدعة ; "
                    "«таухид»→توحيد / التوحيد ; «ляхуа хадис»→لهو الحديث ; «сабр»→صبر / الصبر ; «вуду»→وضوء / الوضوء.\n"
                    "• ОПИСАНИЕ ХАДИСА/АЯТА по смыслу (напр. «хадис о намерениях», «дела по намерениям», «хадис об "
                    "иджтихаде судьи»): верни ХАРАКТЕРНУЮ КЛЮЧЕВУЮ ФРАЗУ из самого текста по-арабски — "
                    "минимально-уникальное словосочетание, по которому он реально находится, ПЕРВОЙ строкой. "
                    "Примеры: «дела по намерениям»→إنما الأعمال بالنيات (и الأعمال بالنيات) ; «иджтихад судьи»→إذا حكم "
                    "الحاكم فاجتهد ; «кто обманул нас»→من غشنا فليس منا. Бери РЕАЛЬНЫЕ слова текста, не пересказ.\n"
                    "• ТЕМА/СМЫСЛ одним словом (напр. «терпение», «права соседа», «music»): верни 4-8 ключевых "
                    "арабских слов/фраз по теме (с артиклем и без).\n"
                    "Если сомневаешься — считай это транскрипцией и верни буквальное арабское слово ПЕРВЫМ.\n"
                    "Каждое выражение — с новой строки. ТОЛЬКО арабские слова, без перевода, без пояснений, без нумерации.")
